//      设计一个输入电话簿内容的用户界面，应该包括姓名、工作单位、职务住宅电话、手机电话、办公室电话等内容。
//  当用户提交输入信息后，弹出一个提示框，将输入的内容显示在其中。
import javax.swing.*;

import java.awt.*;
import java.awt.event.*;

public class p183_two_2 extends JFrame implements ActionListener{
...
//		 setResizable(false);
	...
	public static void main(String args[]){
		p183_two_2 frame=new p183_two_2();
	}
}